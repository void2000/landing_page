              ...
              <div class="content d-flex flex-column justify-content-center" data-aos="fade-left">
                <h3 class="ml6">
                  <span class="text-wrapper">
                    <span class="letters">SKILL WEB SOLUTION</span> 
                  </span>
                </h3>
                <p style="font-size: 20px;">Цель нашей компании - удовлетворить самых требовательных клиентов. SKILL WEB предоставляет услуги любого 
                  уровня сложности. Наша профессиональная команда имеет большой опыт в создании веб-сайтов,
                   логотипов и их дальнейшем продвижении в поисковых системах, таких как Google, Yandex или в социальных сетях.</p>
                
                 
                <div class="row">
                  <div class="col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="100">
                    <i class="bx bx-receipt"></i>
                    <h4>Сайт под шаблон</h4>
                    <p>Создание сайта, включающего в себя "Пакет функций" на выбор</p>
                  </div>
                  <div class="col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="200">
                    <i class="bx bx-cube-alt"></i>
                    <h4>Сайт на ваш лад</h4>
                    <p>Создание и оформление сайтов и логотипов, удовлетворяющих ваше любое желание</p>
                  </div>
                  <div class="col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="300">
                    <i class="bx bx-images"></i>
                    <h4>Логотипы</h4>
                    <p>Создание красивого и современного логотипа по вашей тематике</p>
                  </div>
                  <div class="col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="400">
                    <i class="bx bx-shield"></i>
                    <h4>Реклама</h4>
                    <p>Продвижение вашей компании в поисковых системах и социальных сетях</p>
                  </div>
                </div>
              </div><!-- End .content-->
            </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                ...
                <h4><a href="#">Сайт под шаблон</a></h4>
                <p>Разработка и оформление сайта по ранее наработанным шаблонам, идеальное решение для небольших и средних компаний, которым необходим простой, но красивый и оптимизированный сайт.</p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                <i class="icofont-chart-bar-graph" style="color: #07cc70;"></i>
                <h4><a href="#">Сайт на ваш лад</a></h4>
                <p>Разработка и оформление сайта с нуля, специально для вас, по вашим критериям и требованиям.</p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
                ...
                <p>Создание логотипа по тематике вашей компании, который мы придумаем за вас.</p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
                <i class="icofont-settings" style="color: #f0b103;"></i>
                <h4><a href="#">Логотип на ваш лад</a></h4>
                <p>Создание качественного логотипа, соответствующего вашим техническим требованиям</p>
              </div>
            </div>
            <div class="col-md-6">
          ...
          <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <div class="portfolio-wrap">
                  <img src="{{$tems->img}}" class="img-fluid" alt="">  
